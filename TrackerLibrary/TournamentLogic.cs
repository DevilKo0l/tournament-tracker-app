...
namespace TrackerLibrary
{
    public static class TournamentLogic
    {
        ...
        // Check if it is big enough If not, add in byte 2*2*2*2 - 2^4
        // Create everky round after that - 8 matchups - 4 matchups - 2 matchups - 1 matchup
